...
export function CrmEmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      <div className="w-16 h-16 rounded-2xl bg-fyness-primary/10 ring-1 ring-fyness-primary/15 flex items-center justify-center mb-4">
        <Icon size={28} className="text-fyness-primary dark:text-blue-400" />
      </div>
      ...
      {action && (
        <button
          ...
          className="px-4 py-2 text-sm font-medium bg-fyness-primary hover:bg-fyness-secondary text-white rounded-lg transition-colors"
        >
          {action.label}
        </button>
      )}
