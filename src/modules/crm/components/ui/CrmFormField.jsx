...
export function CrmFormField({
  ...
  const baseClass = `w-full px-3 py-2 rounded-xl border text-sm transition-colors
    ${error
      ? 'border-rose-300 dark:border-rose-700 focus:ring-rose-500 focus:border-rose-500'
      : 'border-slate-300/70 dark:border-white/10 focus:ring-fyness-primary focus:border-fyness-primary'
    }
    bg-white/70 dark:bg-slate-800/60 backdrop-blur text-slate-800 dark:text-slate-200
