...
import MetaSocialIntegration from '../../components/settings/MetaSocialIntegration';
    ...
    <div className="max-w-4xl mx-auto">
      ...
      {activeTab === 'profile' && (
        <div className="space-y-6">
          ...
          {/* Financeiro por pessoa (salário/valor-hora) removido — resquício do
              custo operacional de O.S.; app é CRM. Os campos salaryMonth/hoursMonth
              seguem no perfil (banco), só não aparecem mais aqui. */}
